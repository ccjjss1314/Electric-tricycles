...
uint8_t    Manage_Data_Buff[Manage_Data_Buff_Len];//缓存数据
uint32_t   Manage_num_Buff[Manage_num_Buff_Len];//记录缓存数据的个数
uint8_t    Manage_Buff_Copy[Manage_Buff_Copy_Len];//提取缓存的数据

buff_manage_struct buff_manage_struct_test;//定义缓存管理变量
